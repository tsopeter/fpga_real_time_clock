...
HD_PWD='C:/Users/tsope/Documents/GitHub/fpga_real_time_clock/fpga_real_time_clock/fpga_real_time_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_clock.tcl -notrace
