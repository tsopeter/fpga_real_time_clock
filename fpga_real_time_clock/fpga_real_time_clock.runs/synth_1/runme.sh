...
HD_PWD='C:/Users/tsope/Documents/GitHub/fpga_real_time_clock/fpga_real_time_clock/fpga_real_time_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_clock.tcl
